...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/basketball/girls/girls_basketball_1_726.csv', names=["Team_1", "Team_2", "Score", "Date","Result_Team_1","Location","Time","Team_2_City","Team_2_State","Team_1_Address"])
# df = pd.read_csv('~/Documents/texas_football/basketball/girls/girls_basketball_header.csv', names=["Team_1", "Team_2", "Score", "Date","Result_Team_1","Location","Time","Team_2_City","Team_2_State","Team_1_Address"])
...
df.to_csv('polished_girls_basketball_1.csv')
