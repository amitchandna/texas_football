...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/volleyball/full_volleyball_linux.csv', names=["Team_1", "Team_1_Games_Won", "Team_1_Games_List", "Team_2", "Team_2_Games_Won", "Team_2_Games_List", "Date","Result_Team_1","Location","Time","Team_2_City","Team_2_State","Team_1_Address"])
...
df = df.drop(columns={'Team_1_Address',4,5})
...
df['Team_1_City'] = df['Team_1_City'].str.lstrip()
df['Team_1_State'] = df['Team_1_State'].str.lstrip()
df['Team_1_Zip'] = df['Team_1_Zip'].str.lstrip()
df['Team_1_Home_Away'] = df['Team_1_Home_Away'].str.rstrip()
df['League_District_Nondistrict'] = df['League_District_Nondistrict'].str.lstrip()
...
df.to_csv('clean_linux_volleyball_1.csv')
