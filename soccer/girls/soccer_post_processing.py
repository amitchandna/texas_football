...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/soccer/girls/girls_soccer_1_107.csv', names=["Team_1", "Team_2", "Score", "Date","Result_Team_1","Location","Time","Team_2_City","Team_2_State","Team_1_Address"])
...
df.to_csv('clean_girls_soccer_1.csv')
