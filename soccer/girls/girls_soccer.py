...
url_names = 'https://www.maxpreps.com/rankings/girls-soccer-winter-17-18/{}/national.htm'
url_scores = 'https://www.maxpreps.com/high-schools/{})/girls-soccer-winter-17-18/schedule.htm'
...
for name in tqdm(my_keys):
    counter = counter+1
    if(counter % 100 == 0):
        notify.send('Girls Soccer got to school #' + str(counter))
    ...
    try:
        ...
        team_1 = team_1[0:team_1.find(" Soccer")-1]
    ...
    for item in soup.find_all('tr'):
        ...
        append_list_as_row('girls_soccer_1_107.csv', row)
