...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/soccer/boys/boys_soccer_1_116.csv', names=["Team_1", "Team_2", "Score", "Date","Result_Team_1","Location","Time","Team_2_City","Team_2_State","Team_1_Address"])
# df = pd.read_csv('~/Documents/texas_football/soccer/boys/boys_soccer_header.csv', names=["Team_1", "Team_2", "Score", "Date","Result_Team_1","Location","Time","Team_2_City","Team_2_State","Team_1_Address"])
...
df.to_csv('clean_boys_soccer_1.csv')
