...
url_names = 'https://www.maxpreps.com/rankings/soccer-winter-17-18/{}/national.htm'
url_scores = 'https://www.maxpreps.com/high-schools/{})/soccer-winter-17-18/schedule.htm'
...
for name in tqdm(my_keys):
    counter = counter+1
    if(counter % 100 == 0):
        notify.send('Boys Soccer got to school #' + str(counter))
    ...
    for item in soup.find_all('tr'):
        ...
        append_list_as_row('boys_soccer_1_116.csv', row)
