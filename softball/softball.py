...
url_names = 'https://www.maxpreps.com/rankings/softball-spring-18/{}/national.htm'
url_scores = 'https://www.maxpreps.com/high-schools/{})/softball-spring-18/schedule.htm'
...
for name in tqdm(my_keys):
    ...
    try:
        ...
        team_1 = team_1[0:team_1.find("Softba")-1]
    ...
    for item in soup.find_all('tr'):
        ...
        append_list_as_row('girls_softball_363.csv', row)
