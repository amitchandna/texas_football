...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/softball/full_preprocessed_girls_softball.csv', names=["Team_1", "Team_2", "Score", "Date","Result_Team_1","Location","Time","Team_2_City","Team_2_State","Team_1_Address"])
# df = pd.read_csv('~/Documents/texas_football/softball/girls_softball_header.csv', names=["Team_1", "Team_2", "Score", "Date","Result_Team_1","Location","Time","Team_2_City","Team_2_State","Team_1_Address"])
...
df.to_csv('clean_girls_softball_1.csv')
