...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/field/long_jump/boys/boys_longjump_1_53.csv', names=['School', 'Rank', 'Distance_String', 'Wind', 'Date', 'Address'])
...
df.to_csv('clean_boys_longjump_1.csv')
