...
url_table = 'https://www.maxpreps.com/leaders/track-field-spring-18/horizontal,long+jump/stat-leaders-{}.htm'
...
for x in tqdm(range(0,54,1)):
    ...
    for item in sopa.find_all('tr'):
        ...
        if should_write:
            ...
            append_list_as_row('boys_100m_1_81.csv', row)
