...
url_table = 'https://www.maxpreps.com/leaders/girls-track-field-spring-18/horizontal,long+jump/stat-leaders-{}.htm'
...
for x in tqdm(range(0,41,1)):
    ...
    for item in sopa.find_all('tr'):
        ...
        if should_write:
            ...
            append_list_as_row('girls_long_jump_1_40.csv', row)
