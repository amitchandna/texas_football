...
url_table = ' https://www.maxpreps.com/leaders/girls-track-field-spring-18/throwing,shot+put/stat-leaders-{}.htm'
...
for x in tqdm(range(0,44,1)):
    ...
    for item in sopa.find_all('tr'):
        ...
        if should_write:
            ...
            append_list_as_row('girls_shotput_1_43.csv', row)
