...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/field/shotput/girls/girls_shotput_1_43.csv', names=['School', 'Rank', 'Distance_String', 'Date', 'Address'])
# df = pd.read_csv('~/Documents/texas_football/field/long_jump/girls/girls_shotput_header.csv', names=['School', 'Rank', 'Distance_String', 'Date', 'Address'])
...
df = df[['School', 'Rank', 'Distance_String', 'Distance_Numeric', 'Date', 'Street_Address', 'City', 'State', 'Zip']]
...
df.to_csv('clean_girls_shotput_1.csv')
