...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/field/shotput/boys/boys_shotput_1_55.csv', names=['School', 'Rank', 'Distance_String', 'Date', 'Address'])
# df = pd.read_csv('~/Documents/texas_football/field/long_jump/boys/boys_shotput_header.csv', names=['School', 'Rank', 'Distance_String', 'Date', 'Address'])
...
df.to_csv('clean_boys_shotput_1.csv')
