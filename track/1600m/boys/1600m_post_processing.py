...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/track/1600m/boys/boys_1600m_1_66.csv', names=['School', 'Rank', 'Time_String',  'Date', 'Address'])
...
df.to_csv('clean_boys_100m_1.csv')
