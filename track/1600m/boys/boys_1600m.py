...
url_table = 'https://www.maxpreps.com/leaders/track-field-spring-18/long+distance,1600+meter/stat-leaders-{}.htm'
...
for x in tqdm(range(0,67,1)):
    ...
    for item in sopa.find_all('tr'):
        ...
        if should_write:
            ...
            append_list_as_row('boys_1600m_1_47.csv', row)
