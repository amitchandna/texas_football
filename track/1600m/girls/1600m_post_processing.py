...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/track/1600m/girls/girls_1600m_1_47.csv', names=['School', 'Rank', 'Time_String',  'Date', 'Address'])
...
df.to_csv('clean_girls_1600m_1.csv')
