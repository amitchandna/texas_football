...
url_table = 'https://www.maxpreps.com/leaders/girls-track-field-spring-18/long+distance,1600+meter/stat-leaders-{}.htm'
...
for x in tqdm(range(0,48,1)):
    ...
    for item in sopa.find_all('tr'):
        ...
        if should_write:
            ...
            append_list_as_row('girls_1600m_1_47.csv', row)
