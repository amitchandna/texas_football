...
url_table = 'https://www.maxpreps.com/leaders/girls-track-field-spring-18/long+distance,3200+meter/stat-leaders-{}.htm'
...
for x in tqdm(range(0,29,1)):
    ...
    for item in sopa.find_all('tr'):
        ...
        if should_write:
            ...
            append_list_as_row('girls_3200m_1_28.csv', row)
