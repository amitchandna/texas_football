...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/track/3200m/boys/boys_3200m_1_46.csv', names=['School', 'Rank', 'Time_String',  'Date', 'Address'])
...
df.to_csv('clean_boys_3200m_1.csv')
