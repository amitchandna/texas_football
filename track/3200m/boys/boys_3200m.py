...
url_table = 'https://www.maxpreps.com/leaders/track-field-spring-18/long+distance,3200+meter/stat-leaders-{}.htm'
...
for x in tqdm(range(0,47,1)):
    ...
    for item in sopa.find_all('tr'):
        ...
        if should_write:
            ...
            append_list_as_row('boys_3200m_1_46.csv', row)
