...
url_table = 'https://www.maxpreps.com/leaders/girls-track-field-spring-18/sprints,100+meter/stat-leaders-{}.htm'
...
for x in tqdm(range(0,71,1)):
    ...
    for item in sopa.find_all('tr'):
        ...
        if should_write:
            ...
            append_list_as_row('girls_100m_1_70.csv', row)
