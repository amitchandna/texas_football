...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/track/100m/girls/girls_100m_1_70.csv', names=['School', 'Rank', 'Time_String', 'Wind', 'Date', 'Address'])
...
df = df[['School', 'Rank', 'Time_String', 'Time_Seconds', 'Wind', 'Date', 'Street_Address', 'City', 'State', 'Zip']]
...
df.to_csv('clean_girls_100m_1.csv')
