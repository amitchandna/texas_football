...
schools_indexer = "https://www.maxpreps.com/search/default.aspx?gendersport=boys,swimming&state={}&type=school"
schedule_indexer_a = "https://www.maxpreps.com/local/team/schedule.aspx?schoolid={}&ssid=5e032f74-bbf6-4b3e-b34f-fe41fc4cc6df"
schedule_indexer_b = "https://www.maxpreps.com/local/team/schedule.aspx?schoolid={}&ssid=9b2bb537-91f2-4a67-8efc-e79fc52d129e"
schedule_indexer_c = "https://www.maxpreps.com/local/team/schedule.aspx?schoolid={}&ssid=e95a611c-e62c-497d-9415-7302cc399a41"
...
for x in tqdm(school_ids):
    ...
    for schedule_index in range(0, 3, 1):
        ...
        for competition in table_rows:
            ...
            if should_write:
                append_list_as_row('girls_swimming.csv', row)
