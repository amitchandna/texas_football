...
# notify.send('Running')
df = pd.read_csv('~/Documents/texas_football/swimming/girls/good_girls_swimming.csv', names=["Team_1", "Team_2", "Score", "Date","Time","Location","Team_2_CityState","Team_1_Address"])
...
df.to_csv('clean_girls_swimming_2.csv')
